    ...
    switch (type) {
      case 'X':
        ...
        if (brain.crosshair) {
          ...
          brain.planes.contextX.fillRect(
            brain.numSlice.Y, offZ, 0.2, nZ - 2 * offZ)
          brain.planes.contextX.fillRect(
            offY, nZ - brain.numSlice.Z - 1, nY - 2 * offY, 0.2)
        }
      ...
      case 'Y':
        ...
        if (brain.crosshair) {
          ...
          brain.planes.contextY.fillRect(brain.numSlice.X, offZ, 0.2,
            brain.nbSlice.Z - 2 * offZ)
          brain.planes.contextY.fillRect(offX, brain.nbSlice.Z -
            brain.numSlice.Z - 1, brain.nbSlice.X - 2 * offX, 0.2)
        }
      ...
      case 'Z':
        ...
        if (brain.crosshair) {
          ...
          brain.planes.contextZ.fillRect(offY, brain.numSlice.X,
            brain.nbSlice.Y - 2 * offY, 0.2)
          brain.planes.contextZ.fillRect(brain.numSlice.Y, offX, 0.2,
